        ...
        extends Relational_DbSpecific_UsingPureClientTestSuite
{
    ...
    {
        return createSuite("meta::external::store::relational::tests::dbSpecificTests::redshift", "org/finos/legend/engine/server/test/userTestConfig_withRedshiftTestConnection.json");
    }
}
