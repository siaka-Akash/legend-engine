...
public class TestRelationalExecutor extends AlloyTestServer
{
    ...
    //executionPlan({dt:DateTime[1]|ProductSynonym.allVersions()->filter(p|$p.testDateTime==$dt)}, meta::external::store::relational::tests::milestoning::milestoningmap, ^Runtime(connections = ^$connection(timeZone='EST')))
    ...
    private String getTemplatePlanWithNoTz()
    {
        return "{\n" +
                ...
                "    \"_type\": \"relational\",\n" +
                "    \"resultType\": {\n" +
                "      \"class\": \"meta::external::store::relational::tests::milestoning::ProductSynonym\",\n" +
                "      \"setImplementations\": [\n" +
                "        {\n" +
                "          \"class\": \"meta::external::store::relational::tests::milestoning::ProductSynonym\",\n" +
                "          \"mapping\": \"meta::external::store::relational::tests::milestoning::milestoningmap\",\n" +
                "          \"id\": \"meta_external_store_relational_tests_milestoning_ProductSynonym\",\n" +
                "          \"propertyMappings\": [\n" +
                "            {\n" +
                "              \"property\": \"synonym\",\n" +
                "              \"type\": \"String\"\n" +
    ...
    public void testPlanWitGMTTimeZoneConversionForDateTimeQueryConstant() throws IOException
    {
        ...
        Assert.assertEquals("{\"builder\": {\"_type\":\"classBuilder\",\"mapping\":\"meta::external::store::relational::tests::milestoning::milestoningmap\",\"classMappings\":[{\"setImplementationId\":\"meta_external_store_relational_tests_milestoning_ProductSynonym\",\"properties\":[{\"property\":\"synonym\",\"type\":\"String\"},{\"property\":\"type\",\"type\":\"String\"},{\"property\":\"testDate\",\"type\":\"Date\"},{\"property\":\"testDateTime\",\"type\":\"DateTime\"}],\"class\":\"meta::external::store::relational::tests::milestoning::ProductSynonym\"}],\"class\":\"meta::external::store::relational::tests::milestoning::ProductSynonym\"}, \"activities\": [{\"_type\":\"relational\",\"sql\":\"select \\\"root\\\".name as \\\"pk_0\\\", \\\"root\\\".synonym as \\\"pk_1\\\", \\\"root\\\".type as \\\"pk_2\\\", \\\"root\\\".synonym as \\\"synonym\\\", \\\"root\\\".type as \\\"type\\\", \\\"root\\\".testDate as \\\"testDate\\\", \\\"root\\\".testDateTime as \\\"testDateTime\\\", \\\"root\\\".from_z as \\\"k_businessDate\\\" from ProductSynonymTable as \\\"root\\\" where \\\"root\\\".testDateTime = '2014-12-04 15:22:23.123456789'\"}], \"result\" : {\"columns\" : [\"pk_0\",\"pk_1\",\"pk_2\",\"synonym\",\"type\",\"testDate\",\"testDateTime\",\"k_businessDate\"], \"rows\" : [{\"values\": [\"GS-ModA\",\"GS-Mod-S1\",\"STOCK\",\"GS-Mod-S1\",\"STOCK\",\"2015-06-26\",\"2014-12-04T15:22:23.123456789+0000\",\"2015-08-26T00:00:00.000000000+0000\"]}]}}", result.flush(new RelationalResultToJsonDefaultSerializer(result)));
    }
